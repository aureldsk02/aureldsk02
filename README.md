...
I'm a **Software Engineer**, **DevOps Enthusiast**, and **Cybersecurity Enthusiast** passionate about building web applications, blockchain technologies, and cybersecurity.  
Currently, I'm a second-year student at **Epitech Bénin**, driven by the desire to **solve real-world problems through technology**. 🚀
...
### 💡 What I'm Working On:
- 🛍️ **Akwêba** – An app that allows users to create their own mini online store
...
- 🛒 **Akwêba – Mini e-commerce builder for entrepreneurs**
...
- 📚 **Reading** – Especially tech blogs, personal development, and strategic thinking  
- 🎮 **Gaming** – Enjoying strategy and simulation games  
- 🎵 **Music** – Listening to and exploring different genres  
- 🌍 **Exploring new technologies** and learning by doing  
